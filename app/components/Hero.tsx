      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            AI Engineer specializing in Generative AI & Large Language Models.
            </h2>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
            Pioneer in healthcare technology with 20+ years of experience and US Patent. Architecting and implementing enterprise-scale Gen AI solutions that enhance developer productivity across global platforms. Specializing in RAG applications, LLM infrastructures, and intelligent service platforms that are transforming healthcare software development.
            </p>
